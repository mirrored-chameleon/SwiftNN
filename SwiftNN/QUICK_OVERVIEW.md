...
The math engine is custom-built and highly portable. It is structurally inspired by the brilliant matrix optimization work found in the open-source [Surge repository by Jounce]([https://github.com](https://github.com/Jounce/Surge)). 
